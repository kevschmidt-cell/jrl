...
class Dual_Iiwa7(Robot):
    ...
    def __init__(self, verbose: bool = False):
        ...
        urdf_filepath = get_filepath("urdfs/dual_iiwa7/dual_iiwa7.urdf")
        base_link = "left_lbr1_link_0"
        end_effector_link_name = "right_lbr1_link_0"

        # DEBUG: Capsule-Dateien prüfen
        print("Starte Capsule-Check (left)...")
        for i in range(8):
            print(f"  Lade left_link_{i}...")
            _load_capsule(f"urdfs/dual_iiwa7/capsules/link_{i}.txt")

        print("Starte Capsule-Check (right)...")
        for i in range(8):
            print(f"  Lade right_link_{i}...")
            _load_capsule(f"urdfs/dual_iiwa7/capsules/link_{i}.txt")

        collision_capsules_by_link = {
            "world": None,
            "left_lbr1_link_0": _load_capsule("urdfs/dual_iiwa7/capsules/link_0.txt"),
            "left_lbr1_link_1": _load_capsule("urdfs/dual_iiwa7/capsules/link_1.txt"),
            "left_lbr1_link_2": _load_capsule("urdfs/dual_iiwa7/capsules/link_2.txt"),
            "left_lbr1_link_3": _load_capsule("urdfs/dual_iiwa7/capsules/link_3.txt"),
            "left_lbr1_link_4": _load_capsule("urdfs/dual_iiwa7/capsules/link_4.txt"),
            "left_lbr1_link_5": _load_capsule("urdfs/dual_iiwa7/capsules/link_5.txt"),
            "left_lbr1_link_6": _load_capsule("urdfs/dual_iiwa7/capsules/link_6.txt"),
            "left_lbr1_link_7": _load_capsule("urdfs/dual_iiwa7/capsules/link_7.txt"),
            "left_lbr1_link_ee": None,
            "right_lbr1_link_0": _load_capsule("urdfs/dual_iiwa7/capsules/link_0.txt"),
            "right_lbr1_link_1": _load_capsule("urdfs/dual_iiwa7/capsules/link_1.txt"),
            "right_lbr1_link_2": _load_capsule("urdfs/dual_iiwa7/capsules/link_2.txt"),
            "right_lbr1_link_3": _load_capsule("urdfs/dual_iiwa7/capsules/link_3.txt"),
            "right_lbr1_link_4": _load_capsule("urdfs/dual_iiwa7/capsules/link_4.txt"),
            "right_lbr1_link_5": _load_capsule("urdfs/dual_iiwa7/capsules/link_5.txt"),
            "right_lbr1_link_6": _load_capsule("urdfs/dual_iiwa7/capsules/link_6.txt"),
            "right_lbr1_link_7": _load_capsule("urdfs/dual_iiwa7/capsules/link_7.txt"),
            "right_lbr1_link_ee": None
        }
        ignored_collision_pairs= []
        print("Vor Robot.__init__...")
        Robot.__init__(
            self,
            Dual_Iiwa7.name,
            urdf_filepath,
            ...
            collision_capsules_by_link = collision_capsules_by_link,
            verbose = verbose,
            additional_link_name = None,
        )
        print("Nach Robot.__init__...")
...
class Iiwa7_L(Robot):
    ...
    def __init__(self, verbose: bool = False):
        ...
        collision_capsules_by_link = {
            ...
            "lbr1_link_gripper": _load_capsule("urdfs/iiwa7_L/capsules/lbr1_gripper_blender.txt"),
            ...
            "lbr1_true_ee_link": _load_capsule("urdfs/iiwa7_L/capsules/small_ball.txt"),  # This is the link that is used for the end effector pose
        }
...
class Iiwa7_R(Robot):
    name = "iiwa7_R"
    formal_robot_name = "Kuka LBR IIWA7 Right"
    ...
    def __init__(self, verbose: bool = False):
        ...
        collision_capsules_by_link = {
            ...
            "lbr2_link_gripper": _load_capsule("urdfs/iiwa7_R/capsules/lbr2_gripper_blender.txt"),
            ...
            "lbr2_true_ee_link": _load_capsule("urdfs/iiwa7_R/capsules/small_ball.txt"),  # This is the link that is used for the end effector pose
        }
